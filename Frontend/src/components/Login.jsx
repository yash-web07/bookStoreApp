...
function Login() {
  ...
  const onSubmit = async (data) => {
    ...
    await axios.post("https://bookstoreapp-backend-i0ss.onrender.com/user/login", userInfo)
      .then((res) => {
          ...
          <div className="modal-box">
            <form onSubmit={handleSubmit(onSubmit)} method="dialog">
              ...
              <div className='flex justify-around mt-4 items-center'>
                ...
                <p className='text-center'>Not registered? <Link to="/signup" className='underline text-blue-500 curser-pointer'>Signup</Link></p>
              </div>
            </form>
          </div>
        </dialog>
